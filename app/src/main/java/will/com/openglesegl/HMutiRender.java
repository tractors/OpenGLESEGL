...
public class HMutiRender implements HEGLSurfaceView.HGLRender {
...
//            0.5f,0f
    ...
    public HMutiRender(Context context) {
    ...
    public void onSurfaceCreate() {
        ...
        if (index == 0){
            fragmentSource = ShaderUtil.readRawResource(mContext,R.raw.fragment_shader1);
        } else if (index == 1){
            fragmentSource = ShaderUtil.readRawResource(mContext,R.raw.fragment_shader2);
        } else if (index == 2){
            fragmentSource = ShaderUtil.readRawResource(mContext,R.raw.fragment_shader3);
        }
        //创建程序
